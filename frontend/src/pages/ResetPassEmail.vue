            ...
            <form @submit.prevent="recoverPassword">
              <div class="form-group">
                ...
                <div class="text-center">
                  <p class="text-base">Já tem uma conta? <router-link to="/" class="link">Fazer login</router-link></p>
                </div>
              </div>
            </form>
          </div>
...
export default {
  ...
  methods: {
    ...
    async recoverPassword() {
      try {
        await solicitarRedefinicaoSenha(this.email);
