  ...
  <div class="table-container">
    ...
    <table class="finance-table" v-if="!isLoading">
      ...
      <tbody>
        ...
        >
          <td>{{ item.etiqueta ? item.etiqueta.name : 'Desconhecida' }}</td>
...
import ConfirmModal from '../FinancaPessoal/ConfirmModal.vue';
...
export default {
  ...
  setup(props) {
    ...
    const getEtiquetaName = (id) => {
      const etiqueta = props.etiquetas?.find((et) => et.id === id);
      return etiqueta ? etiqueta.name : 'Desconhecida';
    };
