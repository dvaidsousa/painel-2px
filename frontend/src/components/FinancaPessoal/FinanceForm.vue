<template>
    <div class="form-container">
      <div class="form-row">
        ...
        <select v-model="etiquetaSelecionada" class="input-field small-input" aria-label="Etiqueta">
  ...
  import { listarEtiquetas } from '@/services/etiquetasService';
  ...
  export default {
    ...
    setup(props) {
      ...
      const validarCampos = () => {
        ...
        if (!etiquetaSelecionada.value) {
          exibirMensagem('A etiqueta é obrigatória!', false);
          return null;
        }
      ...
      const adicionarTabela = async () => {
        ...
        console.log('Etiqueta selecionada:', etiquetaSelecionada.value);

        novaEntrada.etiquetaId = etiquetaSelecionada.value;
