  ...
  <div v-if="popupVisivel" class="popup">
    <div class="popup-content">
      <div class="form-group">
        <label>Nome:</label>
        <input v-model="linhaEditada.nome" type="text" class="input-field" />
      </div>
      <div class="form-group">
        <label>Valor:</label>
      ...
      <div class="form-group">
        ...
        <input v-model="linhaEditada.dataVencimento" type="date" class="input-field" />
      </div>
  ...
  setup(props, { emit }) {
    ...
    const salvarEdicao = async () => {
      ...
      try {
        ...
        const response = await fetch(`http://localhost:3000/api/contas/editar/${linhaEditada.value.id}`, {
          method: 'PUT',
          headers: {
